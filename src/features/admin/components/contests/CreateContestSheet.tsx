...
import { createContestAction } from "@/server/actions/admin/admin";
import {
    Sheet,
    SheetContent,
    SheetHeader,
        ...
        <Sheet open={open} onOpenChange={setOpen}>
            ...
            <SheetContent className="sm:max-w-[500px] w-full overflow-y-auto">
                <SheetHeader className="pb-6 border-b border-slate-100">
                    <SheetTitle className="text-xl font-bold text-slate-900 tracking-tight">Create New Contest</SheetTitle>
