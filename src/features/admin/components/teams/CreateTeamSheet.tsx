...
import { createTeamAction, getAllContestsForTeamAssignment } from "@/server/actions/admin/admin";
import {
    Sheet,
    SheetContent,
    SheetHeader,
...
import { Plus, Loader2, KeyRound, Monitor, User, ChevronRight } from "lucide-react";
...
const formSchema = z.object({
    ...
    maxDevices: z.number().min(1, "At least 1 device required").max(3, "Maximum 3 devices allowed").default(2),
});
        ...
        <Sheet open={open} onOpenChange={setOpen}>
            ...
            <SheetContent className="w-[400px] sm:w-[540px] p-0 gap-0">
                <SheetHeader className="px-6 py-5 border-b border-slate-100 bg-slate-50/50">
                    <SheetTitle className="text-xl font-bold text-slate-900 tracking-tight">Register New Team</SheetTitle>
                ...
                <ScrollArea className="h-full pr-0">
                    <Form {...form}>
                        <form
                            ...
                            className="flex flex-col flex-1 pb-20" // Add padding bottom for scroll
                        >
                            ...
                            <div className="px-6 py-4 bg-slate-50 border-t border-slate-100 flex justify-end mt-auto">
                                <Button
                                    type="submit"
                                ...
                                >
                                    {loading ? (
                                        ...
                                        <span className="flex items-center justify-center">
                                            Create Team Account <ChevronRight size={16} className="ml-1 opacity-70" />
                                        </span>
                                    )}
                                </Button>
                            </div>
