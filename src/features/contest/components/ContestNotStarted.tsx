...
import { Trophy, FileText, LogOut } from "lucide-react";
      ...
      <div className="max-w-4xl w-full text-center space-y-12">
        ...
        <div className="animate-in fade-in slide-in-from-bottom-4 duration-700 delay-150 space-y-4">
          ...
          <p className="text-lg md:text-xl text-slate-600 max-w-2xl mx-auto">
            Get ready! The contest will begin shortly. Use the time to review
            the rules and check the leaderboard.
          </p>
        </div>
        ...
        {/* Logout Button - Emergency Access */}
