 ...
 * 2-Tier Ranking: Progress (Solved Count) → Time Penalty
 */
export function LiveBoard({
  ...
  // Sort scores by 2-Tier rules: Progress (Solved) → Penalty
  const sortScores = (scores: TeamScoreData[]) => {
    return [...scores].sort((a, b) => {
      ...
      // Tie-breaker: Lowest penalty (ascending)
          ...
          <table className="w-full">
            <thead className="bg-muted">
              <tr className="border-b">
                ...
                <th className="text-center p-4 font-semibold w-40">
                    ...
                    <td className="p-4 text-center">
                      <div className="space-y-1">
                        <div className="text-lg font-extrabold text-green-600">
                          {score.solvedCount} / {totalProblemsCount}
                        </div>
